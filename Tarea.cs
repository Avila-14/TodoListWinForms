...
namespace TodoListWinForms
{
    ...
    public class Tarea
    {
        public string Description { get; set; } // Establece la descripcion de una tarea
        public bool Success { get; set; } // Valor que indica si la tarea esta completada
        ...
        public override string ToString()
        {
            ...
            return Success ? $"[X] {Description}" : $"[ ] {Description}";
        }
    } 
}
